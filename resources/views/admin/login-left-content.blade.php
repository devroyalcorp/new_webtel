...
<body class="bg-body">
    <div class="video-container d-none d-md-block">
        <video autoplay muted loop no-controls>
            <source src="{{ url('royal-auth-page-master/assets/images/idul-fitri.webm') }}" type="video/mp4" />
        </video>
    </div>
    <div class="video-container d-block d-md-none">
        <video autoplay muted loop no-controls>
            <source src="{{ url('royal-auth-page-master/assets/images/idulfitri-mobile.webm') }}" type="video/mp4" />
        </video>
    </div>
    <div class="main py-3">
