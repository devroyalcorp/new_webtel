...
<head>
    ...
    <link href="{{asset('royal-auth-page-master/assets/css/loginKemerdekaan.css?v='.time()) }}" rel="stylesheet" type="text/css">
...
<body class="bg-body">
    ...
    <div class="main pt-3 px-5">
        ...
        <div class="row min-vh-100" style="padding:0px 20px;">
            <div class="col-lg-4 col-md-12 my-auto pe-xl-5 pe-0 ps-0 left-content-wrapper d-flex align-items-xl-start align-items-center justify-content-md-center flex-column">
                <div class="d-flex align-items-xl-start flex-column left-content" style="height:100vh;">
                    <div class="input-form w-100 login-section">
                        <form class="row g-3 d-flex align-items-center justify-content-center" id="form_signin" enctype="multipart/form-data">
                            <div class="mt-3 login-header">
                                <h2 class="company-name">Royal Corporation</h2>
                                <p class="system-name">Employee Management System</p>
                            </div>
                            {{ csrf_field() }}
                            <div class="col-xl-10 col-md-12">
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input type="text" id="input-username" class="form-control rounded-pill shadow form-input"
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <div class="input-group">
                                        <input type="password"
                                            class="form-control input-password-addon rounded-pill shadow form-input"
                                        ...
                                        <span class="input-group-text group-password bg-transparent border-0"
                                            id="basic-addon2" style="font-size: 15pt;margin-top: 8px;">
                                ...
                                <div class="col-md-12 text-center my-2">
                                    <button type="submit" id="sign-button-id-v2" class="btn btn-primary w-100 rounded-pill shadow login-button">Log in</button>
                                </div>
                            </div>
                        </form>
                    </div>
