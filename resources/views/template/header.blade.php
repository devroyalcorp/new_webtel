...
<nav class="navbar navbar-expand-lg navbar-light bg-dark " style="  background-image: linear-gradient(to right, rgb(250, 255, 255), rgba(236, 255, 255));">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse navbar-check" id="navbarTogglerDemo01" style="padding:0 20px 0 20px;color:#4B0082;">
        ...
        <ul class="navbar-nav" style="border-left:2px solid #6c757d;margin-left:auto;padding-left: 5px;">
          <li class="nav-item pr-5">
            @if(!Session::get('login_status'))
              <a class="nav-link login-button-hide" href="{{route('admin.login')}}"><i class="fa fa-sign-in" aria-hidden="true"></i>
                  Login</a>
              <a class="nav-link back-button-hide" style="display:none"; href="{{route('webtel.index')}}"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i>
                Back</a>
            @else
